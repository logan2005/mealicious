    ...
    try {
      ...
      for (const file of imageFiles) {
        ...
        if (uploadResponse.ok && uploadData.success) {
          uploadedImageUrls.push(...uploadData.urls) // Use spread operator to add all URLs
        } else {
          throw new Error(uploadData.message || 'Image upload failed')
        }
      }

      let mainImageUrl = uploadedImageUrls[0] || '';
      ...
      const productData = {
        ...
        nutrition: JSON.stringify(formData.nutrition)
      }
